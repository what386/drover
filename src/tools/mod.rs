...
pub const TOOL_SYSTEM_PROMPT: &str = concat!(
    ...
    "Arguments are space-separated, and multiple values within a single argument are separated by '|'.\n",
    "All paths are relative to the current working directory.\n",
    "\n",
    "  TOOL: glob <pattern> [exclude]   – find paths with optional exclude pattern\n",
    "  TOOL: search <paths> <patterns>  – search file contents for patterns.\n",
    "  TOOL: list <paths>                – list direct children of directories.\n",
    ...
    "- If a path is ambiguous, use list to orient yourself.\n",
